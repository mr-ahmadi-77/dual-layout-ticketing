...
const en: Dict = {
  ...
  "org.col.time": "Time",
  "org.createEvent": "Create event",
  "create.title": "Create a new event",
  "create.subtitle": "Publish an event to your organizer catalog. Buyers will see it on Discover instantly.",
  "create.back": "Back to dashboard",
  "create.name": "Event name",
  "create.namePh": "e.g. Autumn Piano Recital",
  "create.category": "Category",
  "create.city": "City",
  "create.venue": "Venue",
  "create.venuePh": "e.g. Meridian Playhouse",
  "create.date": "Date",
  "create.time": "Time",
  "create.price": "Price from ($)",
  "create.capacity": "Total capacity",
  "create.description": "Description",
  "create.descriptionPh": "Tell fans what makes this event special…",
  "create.selectOne": "Select one",
  "create.cancel": "Cancel",
  "create.publish": "Publish event",
  "create.publishing": "Publishing…",
  "create.demoNote": "Demo only — no data is persisted yet.",
  "create.success.title": "Event published",
  "create.success.body": "Redirecting you back to the dashboard…",
  "status.Paid": "Paid",
  ...
  "admin.stat.venues": "Total venues",
  "admin.stat.capacity": "Total capacity",
  "admin.stat.events": "Active events",
  "admin.stat.occupancy": "Avg. occupancy",
  "admin.search": "Search venues or cities",
  "admin.addVenue": "Add venue",
  "admin.export": "Export",
  "admin.viewAll": "All venues",
  "admin.viewActive": "Active",
  "admin.viewDraft": "Drafts",
  "admin.empty": "No venues match your search.",
  "admin.manage": "Manage",
...
const fa: Dict = {
  ...
  "org.col.time": "زمان",
  "org.createEvent": "ایجاد رویداد",
  "create.title": "ایجاد رویداد جدید",
  "create.subtitle": "رویدادی را در فهرست خود منتشر کنید. خریداران بلافاصله آن را در بخش کشف می‌بینند.",
  "create.back": "بازگشت به داشبورد",
  "create.name": "نام رویداد",
  "create.namePh": "مثلاً کنسرت پیانوی پاییز",
  "create.category": "دسته",
  "create.city": "شهر",
  "create.venue": "سالن",
  "create.venuePh": "مثلاً سالن مریدین",
  "create.date": "تاریخ",
  "create.time": "زمان",
  "create.price": "قیمت از (دلار)",
  "create.capacity": "ظرفیت کل",
  "create.description": "توضیحات",
  "create.descriptionPh": "برای هواداران بگویید چه چیزی این رویداد را ویژه می‌کند…",
  "create.selectOne": "یک مورد را انتخاب کنید",
  "create.cancel": "انصراف",
  "create.publish": "انتشار رویداد",
  "create.publishing": "در حال انتشار…",
  "create.demoNote": "فقط نمایشی — هنوز داده‌ای ذخیره نمی‌شود.",
  "create.success.title": "رویداد منتشر شد",
  "create.success.body": "در حال بازگشت به داشبورد…",
  ...
  "admin.stat.venues": "تعداد سالن‌ها",
  "admin.stat.capacity": "ظرفیت کل",
  "admin.stat.events": "رویدادهای فعال",
  "admin.stat.occupancy": "میانگین اشغال",
  "admin.search": "جستجوی سالن یا شهر",
  "admin.addVenue": "افزودن سالن",
  "admin.export": "خروجی",
  "admin.viewAll": "همه سالن‌ها",
  "admin.viewActive": "فعال",
  "admin.viewDraft": "پیش‌نویس",
  "admin.empty": "سالنی با این جستجو یافت نشد.",
  "admin.manage": "مدیریت",
  "vstatus.Active": "فعال",
